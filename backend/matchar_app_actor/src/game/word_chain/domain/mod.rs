use crate::game::config::{Attribute, MaxRound, MaxTimeout};
use postbox::Actor;
use refinement::GameId;
use std::collections::HashSet;

pub type WordChainGamePostbox = crate::postbox::Postbox<WordChainGameActor>;

pub type WordChainGameCommand = crate::command::Command<WordChainGameActor>;

pub type WordChainGameEvent = crate::event::Event<WordChainGameActor>;
