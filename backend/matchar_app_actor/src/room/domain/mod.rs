use crate::{
    ...
    pool::Pool,
    user::{UserActor, UserPostbox},
};
use postbox::Actor;
use refinement::{RoomId, UserId};

pub type RoomPostbox = crate::postbox::Postbox<RoomActor>;

pub type RoomCommand = crate::command::Command<RoomActor>;

pub type RoomEvent = crate::event::Event<RoomActor>;
